...
private[boardGame] object LoggerInitializer
{
	...
	val unarySeqLogger = Logger.getLogger("com.rayrobdod.boardGame.UnidirectionalSpaceSeq")
	unarySeqLogger.addHandler(finerConsoleHander)
	unarySeqLogger.setLevel(Level.WARNING)
	
	val rectangularMultifieldLogger = Logger.getLogger("com.rayrobdod.boardGame.swingLayout.RectangularMultifieldComponent")
